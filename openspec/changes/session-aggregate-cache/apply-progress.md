...
## Budget
PR1A diff vs tracker ~280 lines (≤400). PR1B diff vs PR1A ~354 lines (≤400, no exception) — 54 code + 300 test + 2 tasks + ~30 apply-progress. Total vs tracker ~634 but split across chained PRs, each ≤400. No `size:exception`. Readable tests preserved; no minification or lint suppression.
